...
describe('Game', function () {
  ...
  describe('#countResult()', function () {
    ...
    it('check counting "1" ',async function () {
    ...
    it('check counting "2" ',async function () {
    ...
    it('check counting "3" ',async function () {
    ...
    it('check counting "4" ',async function () {
    ...
    it('check counting "5" ',async function () {
    ...
    it('check counting "6" ',async function () {
    ...
    it('check counting "3x" ',async function () {
    ...
    it('check counting "4x" ',async function () {
    ...
    it('check counting "full" ',async function () {
    ...
    it('check counting "small strit" ',async function () {
    ...
    it('check counting "big strit" ',async function () {
    ...
    it('check counting "general" ',async function () {
